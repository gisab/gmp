 ...
 */
    ...
    class productDetailView0slcPage extends DetailPage
    {
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            $column->SetFullTextWindowHandlerName('productDetailViewGrid0slc_id_handler_list');
            ...
            $column->SetOrderable(false);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('productDetailViewGrid0slc_tags_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(false);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('productDetailViewGrid0slc_json_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        {
            $result = new Grid($this, $this->dataset, 'productDetailViewGrid0slc');
            ...
            $column = new TextViewColumn('id', 'Id', $this->dataset);
            $column->SetOrderable(false);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'productDetailViewGrid0slc_id_handler_list', $column);
            ...
            $column = new TextViewColumn('tags', 'Tags', $this->dataset);
            $column->SetOrderable(false);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'productDetailViewGrid0slc_tags_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for json field
            //
            $column = new TextViewColumn('json', 'Json', $this->dataset);
            $column->SetOrderable(false);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'productDetailViewGrid0slc_json_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    }
    ...
    class productDetailEdit0slcPage extends DetailPageEdit
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('productDetailEdit0slcssearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('productDetailEdit0slcasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('productDetailEditGrid0slc_id_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('productDetailEditGrid0slc_tags_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('productDetailEditGrid0slc_json_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('productDetailEditGrid0slc_id_handler_view');
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('productDetailEditGrid0slc_tags_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('productDetailEditGrid0slc_json_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        public function GetModalGridViewHandler() { return 'productDetailEdit0slc_inline_record_view'; }
        protected function GetEnableModalSingleRecordView() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'productDetailEditGrid0slc');
            ...
            $column = new TextViewColumn('id', 'Id', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'productDetailEditGrid0slc_id_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for tags field
            //
            $column = new TextViewColumn('tags', 'Tags', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'productDetailEditGrid0slc_tags_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for json field
            //
            $column = new TextViewColumn('json', 'Json', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'productDetailEditGrid0slc_json_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for id field
            //
            $column = new TextViewColumn('id', 'Id', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'productDetailEditGrid0slc_id_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for tags field
            //
            $column = new TextViewColumn('tags', 'Tags', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'productDetailEditGrid0slc_tags_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for json field
            //
            $column = new TextViewColumn('json', 'Json', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'productDetailEditGrid0slc_json_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    class slcPage extends Page
    {
        ...
        public function GetPageList()
        {
            ...
            if (GetCurrentUserGrantForDataSource('slc')->HasViewGrant())
                $result->AddPage(new PageLink($this->RenderText('SLC'), 'slc.php', $this->RenderText('SLC Groups'), $currentPageCaption == $this->RenderText('SLC'), false, 'Default'));
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('slcssearch', $this->dataset,
                array('id', 'name'),
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('slcasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            {
              //
            // View column for productDetailView0slc detail
            //
            $column = new DetailColumn(array('id'), 'detail0slc', 'productDetailEdit0slc_handler', 'productDetailView0slc_handler', $this->dataset, 'Product', $this->RenderText('Product'));
              $grid->AddViewColumn($column);
            }
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('slcGrid_name_handler_list');
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('slcGrid_name_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        function CreateMasterDetailRecordGridForproductDetailEdit0slcGrid()
        {
            $result = new Grid($this, $this->dataset, 'MasterDetailRecordGridForproductDetailEdit0slc');
            $result->SetAllowDeleteSelected(false);
        ...
        public function GetModalGridViewHandler() { return 'slc_inline_record_view'; }
        protected function GetEnableModalSingleRecordView() { return true; }
        ...
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'slcGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
               $result->SetAllowDeleteSelected(false);
            else
               $result->SetAllowDeleteSelected(false);   
            ...
            // Http Handlers
            //
            $pageView = new productDetailView0slcPage($this, 'Product', 'Product', array('slcid'), GetCurrentUserGrantForDataSource('slc.'), 'UTF-8', 20, 'productDetailEdit0slc_handler');
            
            $pageView->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('slc.'));
            $handler = new PageHTTPHandler('productDetailView0slc_handler', $pageView);
            GetApplication()->RegisterHTTPHandler($handler);
            $pageEdit = new productDetailEdit0slcPage($this, array('slcid'), array('id'), $this->GetForeingKeyFields(), $this->CreateMasterDetailRecordGridForproductDetailEdit0slcGrid(), $this->dataset, GetCurrentUserGrantForDataSource('slc.'), 'UTF-8');
            
            $pageEdit->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('slc.'));
            $pageEdit->SetShortCaption('Product');
            $pageEdit->SetHeader(GetPagesHeader());
            $pageEdit->SetFooter(GetPagesFooter());
            $pageEdit->SetCaption('Product');
            $pageEdit->SetHttpHandlerName('productDetailEdit0slc_handler');
            $handler = new PageHTTPHandler('productDetailEdit0slc_handler', $pageEdit);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for name field
            //
            ...
            $column->SetEditOperationColumn($editColumn);
            /* </inline edit column> */
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'slcGrid_name_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for name field
            //
            $column = new TextViewColumn('name', 'Name', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'slcGrid_name_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new slcPage("slc.php", "slc", GetCurrentUserGrantForDataSource("slc"), 'UTF-8');
        $Page->SetShortCaption('SLC');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('SLC Groups');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("slc"));
