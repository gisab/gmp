 ...
 */
    ...
    class vqueue_lasthourPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('vqueue_lasthourssearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('vqueue_lasthourasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        public function GetModalGridViewHandler() { return 'vqueue_lasthour_inline_record_view'; }
        protected function GetEnableModalSingleRecordView() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'vqueue_lasthourGrid');
    ...
    try
    {
        $Page = new vqueue_lasthourPage("vqueue_lasthour.php", "vqueue_lasthour", GetCurrentUserGrantForDataSource("vqueue_lasthour"), 'UTF-8');
        $Page->SetShortCaption('Last Hour');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Queue changed in the Last hour');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("vqueue_lasthour"));
