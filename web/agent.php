 ...
 */
    ...
    class agentPage extends Page
    {
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            $column->SetFullTextWindowHandlerName('cli_handler');
        ...
        public function GetModalGridDeleteHandler() { return 'agent_modal_delete'; }
        ...
        protected function CreateGrid()
        {
            ...
            $column->SetInsertOperationColumn($editColumn);
            /* </inline insert column> */
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'cli_handler', $column);
